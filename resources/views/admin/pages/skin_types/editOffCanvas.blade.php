<div class="offcanvas offcanvas-end" tabindex="-1" id="editOffCanvas" style="width: 500px;">
    <div class="offcanvas-header border-bottom">
        <h5 class="offcanvas-title">Edit Skin Type</h5>
        <button type="button" class="btn-close" data-bs-dismiss="offcanvas"></button>
    </div>
    <div class="offcanvas-body">
        <form id="editSkinTypeForm" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="mb-3">
                <label for="edit_name" class="form-label">Skin Type Name <span class="text-danger">*</span></label>
                <input type="text" class="form-control @error('name') is-invalid @enderror" id="edit_name" name="name" required placeholder="e.g. Oily, Dry, Combination">
                @error('name')
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control @error('details') is-invalid @enderror" id="edit_details" name="details" rows="4" placeholder="Enter description or characteristics of this skin type"></textarea>
                @error('details')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            ...
            <div class="mb-3">
                <label for="edit_image" class="form-label">Skin Type Image</label>
            ...
            <div class="d-grid gap-2 mt-4">
                <button type="submit" class="btn btn-primary">
                    <i class="ti ti-check me-1"></i>Update Skin Type
                </button>
...
<script>
    function editSkinType(skinTypeId) {
        // Reset preview
        ...
        // Fetch skin type data
        fetch(`/admin/skin-types/${skinTypeId}/edit`)
            ...
            .then(data => {
                ...
                // Set form action
                document.getElementById('editSkinTypeForm').action = `/admin/skin-types/${skinTypeId}`;
            ...
            .catch(error => {
                ...
                alert('Failed to load skin type data');
            });
    }
