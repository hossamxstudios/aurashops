<div class="wrap-sidebar-account">
    <div class="sidebar-account">
        <div class="account-avatar">
            <div class="image">
                <img src="{{ asset('website/images/avatar/user-account.jpg') }}" alt="{{ $client->full_name }}">
            </div>
            <h6 class="mb_4">{{ $client->full_name }}</h6>
            <div class="body-text-1">{{ $client->email }}</div>
        </div>
        <ul class="my-account-nav">
            <li>
                <a href="{{ route('client.dashboard') }}" class="my-account-nav-item {{ request()->routeIs('client.dashboard') ? 'active' : '' }}">
            ...
            <li>
                <a href="{{ route('client.orders') }}" class="my-account-nav-item {{ request()->routeIs('client.orders') ? 'active' : '' }}">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <li>
                <a href="{{ route('client.addresses') }}" class="my-account-nav-item {{ request()->routeIs('client.addresses*') ? 'active' : '' }}">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <li>
                <a href="{{ route('cart.page') }}" class="my-account-nav-item {{ request()->routeIs('cart.page') ? 'active' : '' }}">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M16.5078 10.8734V6.36686C16.5078 5.17166 16.033 4.02541 15.1879 3.18028C14.3428 2.33514 13.1965 1.86035 12.0013 1.86035C10.8061 1.86035 9.65985 2.33514 8.81472 3.18028C7.96958 4.02541 7.49479 5.17166 7.49479 6.36686V10.8734M4.11491 8.62012H19.8877L21.0143 22.1396H2.98828L4.11491 8.62012Z" stroke="#181818" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                    Shopping Cart
            ...
            <li>
                <a href="{{ route('wishlist.index') }}" class="my-account-nav-item {{ request()->routeIs('wishlist.index') ? 'active' : '' }}">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M20.84 4.61012C20.3292 4.09912 19.7228 3.69376 19.0554 3.4172C18.3879 3.14064 17.6725 2.99829 16.95 2.99829C16.2275 2.99829 15.5121 3.14064 14.8446 3.4172C14.1772 3.69376 13.5708 4.09912 13.06 4.61012L12 5.67012L10.94 4.61012C9.9083 3.57842 8.50903 2.99883 7.05 2.99883C5.59096 2.99883 4.19169 3.57842 3.16 4.61012C2.1283 5.64181 1.54871 7.04108 1.54871 8.50012C1.54871 9.95915 2.1283 11.3584 3.16 12.3901L4.22 13.4501L12 21.2301L19.78 13.4501L20.84 12.3901C21.351 11.8794 21.7563 11.2729 22.0329 10.6055C22.3095 9.93801 22.4518 9.2226 22.4518 8.50012C22.4518 7.77763 22.3095 7.06222 22.0329 6.39476C21.7563 5.7273 21.351 5.12087 20.84 4.61012Z" stroke="#181818" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                    My Wishlist
                </a>
            </li>
            {{-- <li>
                <form action="{{ route('logout') }}" method="POST" class="d-inline">
                    @csrf
                    <a type="submit" class="p-0 my-account-nav-item btn btn-link text-start w-100">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
