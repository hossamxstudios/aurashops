  <!-- Footer -->
                            ...
                            <div class="col-lg-4">
                                <div class="footer-infor">
                                    <div class="footer-logo">
                                        <a href="{{ route('home') }}">
                                            <img src="{{ asset('website/logo.png') }}" alt="" style="width: 215px!important;"  >
                                        </a>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="footer-bottom-wrap">
                                    <div class="left">
                                        <p class="text-caption-1">©2025 AuraShops. Made with <i
                                                class="icon-heart"></i> by <a href="https://hossam-x-studios.com/" style="color: brown;">Hossam X Studios</a> | All Rights Reserved.</p>
        ...
        {{-- Mobile Menu - Included globally --}}
        @include('website.pages.home.mobileMenu')
