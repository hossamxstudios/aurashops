...
<body class="preload-wrapper">
    <div id="wrapper">
        ...
        @include('website.pages.about.header')
        @include('website.pages.about.info')
        @include('website.pages.about.icons')
        @include('website.pages.about.team')
        @include('website.pages.about.partners')
