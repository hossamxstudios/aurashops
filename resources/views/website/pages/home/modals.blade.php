    ...
    <div class="modal fade modal-search" id="search">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div>
                    ...
                    <div class="tf-grid-layout tf-col-2 lg-col-3 xl-col-4 loadmore-item" data-display="4"
                        ...
                        <div class="fl-item card-product card-product-size">
                            <div class="card-product-wrapper">
                                <a href="product-detail.html" class="product-img">
                                    <img class="lazyload img-product" data-src="website/images/products/womens/women-8.jpg"
                                        src="website/images/products/womens/women-8.jpg" alt="image-product">
                                    <img class="lazyload img-hover" data-src="website/images/products/womens/women-9.jpg"
                                        src="website/images/products/womens/women-9.jpg" alt="image-product">
                                </a>
                        ...
                        <div class="fl-item card-product">
                            <div class="card-product-wrapper">
                                <a href="product-detail.html" class="product-img">
                                    <img class="lazyload img-product" data-src="website/images/products/womens/women-171.jpg"
                                        src="website/images/products/womens/women-171.jpg" alt="image-product">
                                    <img class="lazyload img-hover" data-src="website/images/products/womens/women-172.jpg"
                                        src="website/images/products/womens/women-172.jpg" alt="image-product">
                                </a>
                            ...
                            <div class="card-product-info">
                                ...
                                <ul class="list-color-product">
                                    <li class="list-color-item color-swatch active">
                                        ...
                                        <img class="lazyload" data-src="website/images/products/womens/women-171.jpg"
                                            src="website/images/products/womens/women-171.jpg" alt="image-product">
                                    </li>
                                    <li class="list-color-item color-swatch">
                                        <span class="d-none text-capitalize color-filter">Pink</span>
                                        <span class="swatch-value bg-dark-pink"></span>
                                        <img class="lazyload" data-src="website/images/products/womens/women-172.jpg"
                                            src="website/images/products/womens/women-172.jpg" alt="image-product">
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="fl-item card-product card-product-size">
                            <div class="card-product-wrapper">
                                <a href="product-detail.html" class="product-img">
                                    <img class="lazyload img-product" data-src="website/images/products/womens/women-83.jpg"
                                        src="website/images/products/womens/women-83.jpg" alt="image-product">
                                    <img class="lazyload img-hover" data-src="website/images/products/womens/women-84.jpg"
                                        src="website/images/products/womens/women-84.jpg" alt="image-product">
                                </a>
                            ...
                            <div class="card-product-info">
                                ...
                                <ul class="list-color-product">
                                    <li class="list-color-item color-swatch active">
                                        ...
                                        <img class="lazyload" data-src="website/images/products/womens/women-83.jpg"
                                            src="website/images/products/womens/women-83.jpg" alt="image-product">
                                    </li>
                                    <li class="list-color-item color-swatch">
                                        <span class="d-none text-capitalize color-filter">Grey</span>
                                        <span class="swatch-value bg-grey"></span>
                                        <img class="lazyload" data-src="website/images/products/womens/women-94.jpg"
                                            src="website/images/products/womens/women-94.jpg" alt="image-product">
                                    </li>
                                    <li class="list-color-item color-swatch line">
                                        <span class="d-none text-capitalize color-filter">White</span>
                                        <span class="bg-white swatch-value"></span>
                                        <img class="lazyload" data-src="website/images/products/womens/women-87.jpg"
                                            src="website/images/products/womens/women-87.jpg" alt="image-product">
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="fl-item card-product card-product-size">
                            <div class="card-product-wrapper">
                                <a href="product-detail.html" class="product-img">
                                    <img class="lazyload img-product" data-src="website/images/products/womens/women-102.jpg"
                                        src="website/images/products/womens/women-102.jpg" alt="image-product">
                                    <img class="lazyload img-hover" data-src="website/images/products/womens/women-103.jpg"
                                        src="website/images/products/womens/women-103.jpg" alt="image-product">
                                </a>
                                <div class="on-sale-wrap"><span class="on-sale-item">-25%</span></div>
                                <div class="variant-wrap size-list">
                                    <ul class="variant-box">
                            ...
                            <div class="card-product-info">
                                ...
                                <ul class="list-color-product">
                                    <li class="list-color-item color-swatch active">
                                        ...
                                        <img class="lazyload" data-src="website/images/products/womens/women-102.jpg"
                                            src="website/images/products/womens/women-102.jpg" alt="image-product">
                                    </li>
                                    <li class="list-color-item color-swatch">
                                        <span class="d-none text-capitalize color-filter">Orange</span>
                                        <span class="swatch-value bg-light-orange"></span>
                                        <img class="lazyload" data-src="website/images/products/womens/women-111.jpg"
                                            src="website/images/products/womens/women-111.jpg" alt="image-product">
                                    </li>
                                    <li class="list-color-item color-swatch line">
                                        <span class="d-none text-capitalize color-filter">White</span>
                                        <span class="bg-white swatch-value"></span>
                                        <img class="lazyload" data-src="website/images/products/womens/women-104.jpg"
                                            src="website/images/products/womens/women-104.jpg" alt="image-product">
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="fl-item card-product">
                            <div class="card-product-wrapper">
                                <a href="product-detail.html" class="product-img">
                                    <img class="lazyload img-product" data-src="website/images/products/mens/men-11.jpg"
                                        src="website/images/products/mens/men-11.jpg" alt="image-product">
                                    <img class="lazyload img-hover" data-src="website/images/products/mens/men-12.jpg"
                                        src="website/images/products/mens/men-12.jpg" alt="image-product">
                                </a>
                                <div class="list-product-btn">
                                    <a href="javascript:void(0);" class="box-icon wishlist btn-icon-action">
                                        <span class="icon icon-heart"></span>
                        ...
                        <div class="fl-item card-product">
                            <div class="card-product-wrapper">
                                <a href="product-detail.html" class="product-img">
                                    <img class="lazyload img-product" data-src="website/images/products/mens/men-13.jpg"
                                        src="website/images/products/mens/men-13.jpg" alt="image-product">
                                    <img class="lazyload img-hover" data-src="website/images/products/mens/men-14.jpg"
                                        src="website/images/products/mens/men-14.jpg" alt="image-product">
                                </a>
                                <div class="on-sale-wrap"><span class="on-sale-item">-25%</span></div>
                                    ...
                                    <div class="marquee-wrapper">
                                        <div class="initial-child-container">
                                            <div class="marquee-child-item">
                                                <p class="text-white font-2 text-btn-uppercase fw-6">Hot Sale 25% OFF
                                                </p>
                                            </div>
                                            <div class="marquee-child-item">
                            ...
                            <div class="card-product-info">
                                ...
                                <ul class="list-color-product">
                                    <li class="list-color-item color-swatch active">
                                        ...
                                        <img class="lazyload" data-src="website/images/products/mens/men-13.jpg"
                                            src="website/images/products/mens/men-13.jpg" alt="image-product">
                                    </li>
                                    <li class="list-color-item color-swatch">
                                        <span class="d-none text-capitalize color-filter">Light Blue</span>
                                        <span class="swatch-value bg-light-blue-2"></span>
                                        <img class="lazyload" data-src="website/images/products/mens/men-12.jpg"
                                            src="website/images/products/mens/men-12.jpg" alt="image-product">
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="fl-item card-product card-product-size">
                            <div class="card-product-wrapper">
                                <a href="product-detail.html" class="product-img">
                                    <img class="lazyload img-product" data-src="website/images/products/mens/men-7.jpg"
                                        src="website/images/products/mens/men-7.jpg" alt="image-product">
                                    <img class="lazyload img-hover" data-src="website/images/products/mens/men-8.jpg"
                                        src="website/images/products/mens/men-8.jpg" alt="image-product">
                                </a>
                                <div class="on-sale-wrap"><span class="on-sale-item">-25%</span></div>
                                <div class="variant-wrap size-list">
                                    <ul class="variant-box">
                            ...
                            <div class="card-product-info">
                                ...
                                <ul class="list-color-product">
                                    <li class="list-color-item color-swatch active line">
                                        <span class="d-none text-capitalize color-filter">Green</span>
                                        <span class="swatch-value bg-light-green"></span>
                                        <img class="lazyload" data-src="website/images/products/mens/men-7.jpg"
                                            src="website/images/products/mens/men-7.jpg" alt="image-product">
                                    </li>
                                    <li class="list-color-item color-swatch">
                                        <span class="d-none text-capitalize color-filter">Grey</span>
                                        <span class="swatch-value bg-light-grey"></span>
                                        <img class="lazyload" data-src="website/images/products/mens/men-11.jpg"
                                            src="website/images/products/mens/men-11.jpg" alt="image-product">
                                    </li>
                        ...
                        <div class="fl-item card-product">
                            <div class="card-product-wrapper">
                                <a href="product-detail.html" class="product-img">
                                    <img class="lazyload img-product" data-src="website/images/products/mens/men-1.jpg"
                                        src="website/images/products/mens/men-1.jpg" alt="image-product">
                                    <img class="lazyload img-hover" data-src="website/images/products/mens/men-3.jpg"
                                        src="website/images/products/mens/men-3.jpg" alt="image-product">
                                </a>
                                <div class="list-product-btn">
                                    <a href="javascript:void(0);" class="box-icon wishlist btn-icon-action">
                                        <span class="icon icon-heart"></span>
                            ...
                            <div class="card-product-info">
                                ...
                                <ul class="list-color-product">
                                    <li class="list-color-item color-swatch active line">
                                        ...
                                        <img class="lazyload" data-src="website/images/products/mens/men-1.jpg"
                                            src="website/images/products/mens/men-1.jpg" alt="image-product">
                                    </li>
                                    <li class="list-color-item color-swatch">
                                        <span class="d-none text-capitalize color-filter">Pink</span>
                                    ...
                                    <li class="list-color-item color-swatch">
                                        ...
                                        <img class="lazyload" data-src="website/images/products/mens/men-9.jpg"
                                            src="website/images/products/mens/men-9.jpg" alt="image-product">
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="fl-item card-product card-product-size">
                            <div class="card-product-wrapper">
                                <a href="product-detail.html" class="product-img">
                                    <img class="lazyload img-product" data-src="website/images/products/womens/women-37.jpg"
                                        src="website/images/products/womens/women-37.jpg" alt="image-product">
                                    <img class="lazyload img-hover" data-src="website/images/products/womens/women-38.jpg"
                                        src="website/images/products/womens/women-38.jpg" alt="image-product">
                                </a>
                                <div class="variant-wrap size-list">
                                    <ul class="variant-box">
                            ...
                            <div class="card-product-info">
                                ...
                                <ul class="list-color-product">
                                    <li class="list-color-item color-swatch active">
                                        <span class="d-none text-capitalize color-filter">Light Blue</span>
                                        <span class="swatch-value bg-light-blue"></span>
                                        <img class="lazyload" data-src="website/images/products/womens/women-37.jpg"
                                            src="website/images/products/womens/women-37.jpg" alt="image-product">
                                    </li>
                                    <li class="list-color-item color-swatch line">
                                        <span class="d-none text-capitalize color-filter">White</span>
                                        <span class="bg-white swatch-value"></span>
                                        <img class="lazyload" data-src="website/images/products/womens/women-41.jpg"
                                            src="website/images/products/womens/women-41.jpg" alt="image-product">
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="fl-item card-product card-product-size">
                            <div class="card-product-wrapper">
                                <a href="product-detail.html" class="product-img">
                                    <img class="lazyload img-product" data-src="website/images/products/mens/men-15.jpg"
                                        src="website/images/products/mens/men-15.jpg" alt="image-product">
                                    <img class="lazyload img-hover" data-src="website/images/products/mens/men-16.jpg"
                                        src="website/images/products/mens/men-16.jpg" alt="image-product">
                                </a>
                                <div class="variant-wrap size-list">
                                    <ul class="variant-box">
                                        <li class="size-item">XS</li>
                            ...
                            <div class="card-product-info">
                                ...
                                <ul class="list-color-product">
                                    <li class="list-color-item color-swatch active">
                                        <span class="d-none text-capitalize color-filter">Beige</span>
                                        <span class="swatch-value bg-beige"></span>
                                        <img class="lazyload" data-src="website/images/products/mens/men-15.jpg"
                                            src="website/images/products/mens/men-15.jpg" alt="image-product">
                                    </li>
                                    <li class="list-color-item color-swatch">
                                        <span class="d-none text-capitalize color-filter">Black</span>
                                        <span class="swatch-value bg-main"></span>
                                        <img class="lazyload" data-src="website/images/products/mens/men-18.jpg"
                                            src="website/images/products/mens/men-18.jpg" alt="image-product">
                                    </li>
                                    <li class="list-color-item color-swatch">
                                        <span class="d-none text-capitalize color-filter">Dark Blue</span>
                                        <span class="swatch-value bg-dark-blue"></span>
                                        <img class="lazyload" data-src="website/images/products/mens/men-17.jpg"
                                            src="website/images/products/mens/men-17.jpg" alt="image-product">
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="fl-item card-product">
                            <div class="card-product-wrapper">
                                <a href="product-detail.html" class="product-img">
                                    <img class="lazyload img-product" data-src="website/images/products/womens/women-167.jpg"
                                        src="website/images/products/womens/women-167.jpg" alt="image-product">
                                    <img class="lazyload img-hover" data-src="website/images/products/womens/women-168.jpg"
                                        src="website/images/products/womens/women-168.jpg" alt="image-product">
                                </a>
                                <div class="list-product-btn">
                                    <a href="javascript:void(0);" class="box-icon wishlist btn-icon-action">
                                        <span class="icon icon-heart"></span>
                            ...
                            <div class="card-product-info">
                                ...
                                <ul class="list-color-product">
                                    <li class="list-color-item color-swatch active line">
                                        <span class="d-none text-capitalize color-filter">White</span>
                                        <span class="bg-white swatch-value"></span>
                                        <img class="lazyload" data-src="website/images/products/womens/women-167.jpg"
                                            src="website/images/products/womens/women-167.jpg" alt="image-product">
                                    </li>
                                    <li class="list-color-item color-swatch">
                                        <span class="d-none text-capitalize color-filter">Beige</span>
                                        <span class="swatch-value bg-beige"></span>
                                        <img class="lazyload" data-src="website/images/products/womens/women-162.jpg"
                                            src="website/images/products/womens/women-162.jpg" alt="image-product">
                                    </li>
                        ...
                        <div class="fl-item card-product card-product-size">
                            <div class="card-product-wrapper">
                                <a href="product-detail.html" class="product-img">
                                    <img class="lazyload img-product" data-src="website/images/products/mens/men-19.jpg"
                                        src="website/images/products/mens/men-19.jpg" alt="image-product">
                                    <img class="lazyload img-hover" data-src="website/images/products/mens/men-20.jpg"
                                        src="website/images/products/mens/men-20.jpg" alt="image-product">
                                </a>
                                <div class="variant-wrap size-list">
                                    <ul class="variant-box">
                                        <li class="size-item">XS</li>
                ...
                <!-- Load Item -->
                <div class="text-center wd-load view-more-button">
                    ...
                    <div class="row-demo">
                        <div class="demo-item">
                            <a href="index-2.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload" data-src="website/images/demo/home-fashion-womenswear.jpg"
                                        src="website/images/demo/home-fashion-womenswear.jpg" alt="home-fashion-womenswear">
                        ...
                        <div class="demo-item">
                            <a href="home-fashion-eleganceNest.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload" data-src="website/images/demo/home-fashion-eleganceNest.jpg"
                                        src="website/images/demo/home-fashion-eleganceNest.jpg" alt="home-fashion-eleganceNest">
                                    <div class="demo-label">
                                        <span class="demo-new">New</span>
                        ...
                        <div class="demo-item">
                            <a href="home-fashion-main.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload" data-src="website/images/demo/home-fashion-main.jpg"
                                        src="website/images/demo/home-fashion-main.jpg" alt="home-fashion-main">
                                    <div class="demo-label">
                                        <span class="demo-hot">Hot</span>
                                    </div>
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-fashion-trendset.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="website/images/demo/home-fashion-trendset.jpg"
                                        src="website/images/demo/home-fashion-trendset.jpg" alt="home-fashion-trendset">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-fashion-vogueLing.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="website/images/demo/home-fashion-vogueLiving.jpg"
                                        src="website/images/demo/home-fashion-vogueLiving.jpg" alt="home-fashion-vogueLiving">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-fashion-elegantAbode.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="website/images/demo/home-fashion-elegantAbode.jpg"
                                        src="website/images/demo/home-fashion-elegantAbode.jpg" alt="home-fashion-elegantAbode">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-fashion-glamDwell.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload" data-src="website/images/demo/home-fashion-glamDwell.jpg"
                                        src="website/images/demo/home-fashion-glamDwell.jpg" alt="home-fashion-glamDwell">
                                    <div class="demo-label">
                                        <span class="demo-new">New</span>
                                    </div>
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-fashion-classyCove.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="website/images/demo/home-fashion-classycove.jpg"
                                        src="website/images/demo/home-fashion-classycove.jpg" alt="home-fashion-classyCove">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-fashion-chicHaven.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="website/images/demo/home-fashion-chicHaven.jpg"
                                        src="website/images/demo/home-fashion-chicHaven.jpg" alt="home-fashion-chicHaven1">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-fashion-chicHaven-02.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="website/images/demo/home-fashion-chicHaven2.jpg"
                                        src="website/images/demo/home-fashion-chicHaven2.jpg" alt="home-fashion-chicHaven2">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-fashion-tiktok.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="website/images/demo/home-fashion-tiktok.jpg"
                                        src="website/images/demo/home-fashion-tiktok.jpg" alt="home-fashion-tiktok">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-fashion-luxeLiving.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="website/images/demo/home-fashion-luxeLiving.jpg"
                                        src="website/images/demo/home-fashion-luxeLiving.jpg" alt="home-fashion-luxeLiving">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-fashion-modernRetreat.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="website/images/demo/home-fashion-modernRetreat.jpg"
                                        src="website/images/demo/home-fashion-modernRetreat.jpg"
                        ...
                        <div class="demo-item">
                            <a href="home-beauty.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="website/images/demo/home-beauty.jpg"
                                        src="website/images/demo/home-beauty.jpg" alt="home-beauty">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-skincare.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="website/images/demo/home-skinCare.jpg"
                                        src="website/images/demo/home-skinCare.jpg" alt="home-skincare">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-cosmetic.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="website/images/demo/home-cosmetic.jpg"
                                        src="website/images/demo/home-cosmetic.jpg" alt="home-cosmetic">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-decor.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="website/images/demo/home-decor.jpg"
                                        src="website/images/demo/home-decor.jpg" alt="home-decor">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-furniture.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="website/images/demo/home-furniture.jpg"
                                        src="website/images/demo/home-furniture.jpg" alt="home-furniture">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-jewelry-01.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="website/images/demo/home-jewelry.jpg"
                                        src="website/images/demo/home-jewelry.jpg" alt="home-jewelry-elegantGems">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-jewelry-02.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="website/images/demo/home-jewelry2.jpg"
                                        src="website/images/demo/home-jewelry2.jpg" alt="home-jewelry-glitterGlam">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-activewear.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="website/images/demo/home-activewear.jpg"
                                        src="website/images/demo/home-activewear.jpg" alt="home-activewear">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-organic.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="website/images/demo/home-organic.jpg"
                                        src="website/images/demo/home-organic.jpg" alt="home-organic">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-sock.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="website/images/demo/home-sock.jpg"
                                        src="website/images/demo/home-sock.jpg" alt="home-sock">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-camping.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="website/images/demo/home-camping.jpg"
                                        src="website/images/demo/home-camping.jpg" alt="home-camping">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-electronic.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="website/images/demo/home-electronic.jpg"
                                        src="website/images/demo/home-electronic.jpg" alt="home-electronic">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-pet-store.html">
                                <div class="demo-image">
                                    <img class="lazyload" data-src="website/images/demo/home-pet-store.jpg"
                                        src="website/images/demo/home-pet-store.jpg" alt="home-pet-store">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-pickleball.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload" data-src="website/images/demo/home-pickleball.jpg"
                                        src="website/images/demo/home-pickleball.jpg" alt="home-pickleball">
                                    <div class="demo-label">
                                        <span class="demo-new">New</span>
                                    </div>
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-sock-2.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload" data-src="website/images/demo/home-sock2.jpg"
                                        src="website/images/demo/home-sock2.jpg" alt="home-sock2">
                                    <div class="demo-label">
                                        <span class="demo-new">New</span>
                                    </div>
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-bookstore.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload" data-src="website/images/demo/home-bookstore.jpg"
                                        src="website/images/demo/home-bookstore.jpg" alt="home-bookstore">
                                    <div class="demo-label">
                                        <span class="demo-new">New</span>
                                    </div>
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-baby.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload" data-src="website/images/demo/home-baby.jpg"
                                        src="website/images/demo/home-baby.jpg" alt="home-baby">
                                    <div class="demo-label">
                                        <span class="demo-new">New</span>
                                    </div>
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-electronics-store.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload" data-src="website/images/demo/home-electronic-store.jpg"
                                        src="website/images/demo/home-electronic-store.jpg" alt="home-electronic-store">
                                    <div class="demo-label">
                                        <span class="demo-new">New</span>
                                    </div>
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-sneaker.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload" data-src="website/images/demo/home-sneaker.jpg"
                                        src="website/images/demo/home-sneaker.jpg" alt="home-sneaker">
                                    <div class="demo-label">
                                        <span class="demo-new">New</span>
                                    </div>
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-gaming.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload" data-src="website/images/demo/home-gaming-accessory.jpg"
                                        src="website/images/demo/home-gaming-accessory.jpg" alt="home-gaming-accessory">
                                    <div class="demo-label">
                                        <span class="demo-new">New</span>
                                    </div>
                                </div>
                        ...
                        <li class="nav-mb-item active">
                            ...
                            <div id="dropdown-menu-one" class="collapse">
                                <ul class="sub-nav-menu">
                                    <li><a href="index-2.html" class="sub-nav-link">Fashion Womenswear</a></li>
                                    ...
                                    <li><a href="home-fashion-trendset.html" class="sub-nav-link active">Fashion
                                            TrendsetHome</a></li>
                                        ...
                                        <div id="sub-product-three" class="collapse">
                                            <ul class="sub-nav-menu sub-menu-level-2">
                                                ...
                                                <li><a href="product-subscribe-save.html" class="sub-nav-link">Subscribe
                                                        Save</a></li>
                                                <li><a href="product-deals-grid.html" class="sub-nav-link">Deals
                                                        Grid</a></li>
                        ...
                        <li class="nav-mb-item">
                            ...
                            <div id="dropdown-menu-five" class="collapse">
                                <ul class="sub-nav-menu">
                                    ...
                                    <li><a href="payment-confirmation.html" class="sub-nav-link">Payment
                                            confirmation</a></li>
            ...
            <div class="canvas-body">
                <div class="wd-facet-categories">
                    <div role="dialog" class="facet-title collapsed" data-bs-target="#forWomen"
                        ...
                        <img class="avt" src="website/images/avatar/women.jpg" alt="avt">
                    ...
                    <div id="forWomen" class="collapse">
                        <ul class="facet-body">
                            <li>
                                <a href="#" class="item link"><img class="avt" src="website/images/avatar/new-in.jpg"
                                        alt="avt"><span class="title-sub text-caption-1 text-secondary">New
                                        in</span></a>
                            </li>
                            <li>
                                <a href="#" class="item link"><img class="avt" src="website/images/avatar/promotion.jpg"
                                        alt="avt"><span
                                        class="title-sub text-caption-1 text-secondary">Promotion</span></a>
                            </li>
                            <li>
                                <a href="#" class="item link"><img class="avt" src="website/images/avatar/clothing.jpg"
                                        alt="avt"><span
                                        class="title-sub text-caption-1 text-secondary">Clothing</span></a>
                            </li>
                            <li>
                                <a href="#" class="item link"><img class="avt" src="website/images/avatar/shoes.jpg"
                                        alt="avt"><span class="title-sub text-caption-1 text-secondary">Shoes</span></a>
                            </li>
                            <li>
                                <a href="#" class="item link"><img class="avt" src="website/images/avatar/bags.jpg"
                                        alt="avt"><span class="title-sub text-caption-1 text-secondary">Bags</span></a>
                            </li>
                            <li>
                                <a href="#" class="item link"><img class="avt" src="website/images/avatar/accessories.jpg"
                                        alt="avt"><span
                                        class="title-sub text-caption-1 text-secondary">Accessories</span></a>
                            </li>
                            <li>
                                <a href="#" class="item link"><img class="avt" src="website/images/avatar/jewelry.jpg"
                                        alt="avt"><span
                ...
                <div class="wd-facet-categories">
                    <div role="dialog" class="facet-title collapsed" data-bs-target="#forMen" data-bs-toggle="collapse"
                        ...
                        <img class="avt" src="website/images/avatar/men.jpg" alt="avt">
                    ...
                    <div id="forMen" class="collapse">
                        <ul class="facet-body">
                            <li>
                                <a href="#" class="item link"><img class="avt" src="website/images/avatar/men.jpg"
                                        alt="avt"><span class="title-sub text-caption-1 text-secondary">Men</span></a>
                            </li>
                            <li>
                                <a href="#" class="item link"><img class="avt" src="website/images/avatar/men.jpg"
                                        alt="avt"><span class="title-sub text-caption-1 text-secondary">Men</span></a>
                ...
                <div class="wd-facet-categories">
                    <div role="dialog" class="facet-title collapsed" data-bs-target="#forKid" data-bs-toggle="collapse"
                        ...
                        <img class="avt" src="website/images/avatar/kid.jpg" alt="avt">
                    ...
                    <div id="forKid" class="collapse">
                        <ul class="facet-body">
                            <li>
                                <a href="#" class="item link"><img class="avt" src="website/images/avatar/kid.jpg"
                                        alt="avt"><span class="title-sub text-caption-1 text-secondary">Kid</span></a>
                            </li>
                            <li>
                                <a href="#" class="item link"><img class="avt" src="website/images/avatar/kid.jpg"
                                        alt="avt"><span class="title-sub text-caption-1 text-secondary">Kid</span></a>
                ...
                <div class="wd-facet-categories">
                    <div role="dialog" class="facet-title collapsed" data-bs-target="#accessories"
                        ...
                        <img class="avt" src="website/images/avatar/accessories.jpg" alt="avt">
            ...
            <div class="modal-content">
                <div class="tf-quick-view-image">
                    <div class="wrap-quick-view wrapper-scroll-quickview">
                        ...
                        <div class="quickView-item item-scroll-quickview" data-scroll-quickview="beige">
                            <img class="lazyload" data-src="website/images/products/womens/women-2.jpg"
                                src="website/images/products/womens/women-2.jpg" alt="">
                        </div>
                        <div class="quickView-item item-scroll-quickview" data-scroll-quickview="gray">
                            <img class="lazyload" data-src="website/images/products/womens/women-3.jpg"
                                src="website/images/products/womens/women-3.jpg" alt="">
                        </div>
                        <div class="quickView-item item-scroll-quickview" data-scroll-quickview="gray">
                            <img class="lazyload" data-src="website/images/products/womens/women-4.jpg"
                                src="website/images/products/womens/women-4.jpg" alt="">
                        </div>
                        <div class="quickView-item item-scroll-quickview" data-scroll-quickview="grey">
                            <img class="lazyload" data-src="website/images/products/womens/women-19.jpg"
                                src="website/images/products/womens/women-19.jpg" alt="">
                        </div>
                        <div class="quickView-item item-scroll-quickview" data-scroll-quickview="grey">
                            <img class="lazyload" data-src="website/images/products/womens/women-20.jpg"
                                src="website/images/products/womens/women-20.jpg" alt="">
                        </div>
                    </div>
                </div>
                <div class="wrap">
                ...
                <div class="tf-minicart-recommendations">
                    ...
                    <div class="wrap-recommendations">
                        <div class="list-cart">
                            ...
                            <div class="list-cart-item">
                                <div class="image">
                                    <img class="lazyload" data-src="website/images/products/womens/women-5.jpg"
                                        src="website/images/products/womens/women-5.jpg" alt="">
                                </div>
                                <div class="content">
                                    <div class="name">
                                        <a class="link text-line-clamp-1" href="product-detail.html">Belt wrap dress</a>
                            ...
                            <div class="list-cart-item">
                                <div class="image">
                                    <img class="lazyload" data-src="website/images/products/womens/women-6.jpg"
                                        src="website/images/products/womens/women-6.jpg" alt="">
                                </div>
                                <div class="content">
                                    <div class="name">
                                        <a class="link text-line-clamp-1" href="product-detail.html">Belt wrap dress</a>
                                    ...
                                    <div class="tf-mini-cart-items" id="cartItemsContainer">
                                        ...
                                        <div class="tf-mini-cart-item file-delete">
                                            ...
                                            <div class="tf-mini-cart-info flex-grow-1">
                                                <div
                                                    class="flex-wrap gap-12 mb_12 d-flex align-items-center justify-content-between">
                                                ...
                                                <div
                                                    class="flex-wrap gap-12 d-flex align-items-center justify-content-between">
                            ...
                            <div class="tf-mini-cart-bottom">
                                ...
                                <div class="tf-mini-cart-bottom-wrap">
                                    <div class="tf-cart-totals-discounts">
                                        <h5>Subtotal</h5>
                                        <h5 class="tf-totals-total-value" id="cartTotal">$0.00</h5>
                                    </div>
            ...
            <div class="modal-content">
                ...
                <div class="wrap">
                    <div class="tf-mini-cart-wrap">
                        <div class="tf-mini-cart-main">
                            <div class="tf-mini-cart-sroll">
                                <div class="tf-mini-cart-items" id="wishlistItemsContainer">
                            ...
                            <div class="tf-compare-list list-file-delete">
                                ...
                                <div class="tf-compare-wrap">
                                    ...
                                    <div class="tf-compare-item file-delete">
                                        ...
                                        <span class="icon-close remove"></span>
                                        <a href="product-detail.html" class="image">
                                            <img class="lazyload" data-src="website/images/products/womens/women-29.jpg"
                                                src="website/images/products/womens/women-29.jpg" alt="">
                                        </a>
                                        <div class="content">
                                            <div class="text-title">
                ...
                <div>
                    <div class="tf-product-info-list">
                        <div class="tf-product-info-item">
                            <div class="image">
                                <img src="website/images/products/womens/women-1.jpg" alt="">
                            </div>
                            <div class="content">
