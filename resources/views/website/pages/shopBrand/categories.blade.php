                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="collection-circle hover-img">
                                <a href="{{ route('shop.category', $allCategory->slug) }}" class="img-style">
                                    <img class="lazyload" data-src="{{ $allCategory->getFirstMediaUrl('category_image') }}" src="{{ $allCategory->getFirstMediaUrl('category_image') }}" alt="collection-img">
                                </a>
                                <div class="text-center collection-content">
                                    <a href="{{ route('shop.category', $allCategory->slug) }}" class="cls-title">
                                        <h6 class="text">{{ $allCategory->name }}</h6>
                                    </a>
                                </div>
                            </div>
                        </div>
