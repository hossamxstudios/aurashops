...
<head>
    <title>Aura - {{ $category->name }}</title>
...
<body class="preload-wrapper">
    <div id="wrapper">
        ...
        @include('website.pages.shopCategory.header')
        @include('website.pages.shopCategory.categories')
        @include('website.pages.shopCategory.products')
