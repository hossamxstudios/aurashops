...
<body class="preload-wrapper">
    <div id="wrapper">
        ...
        @include('website.pages.shopGender.header')
        @include('website.pages.shopGender.categories')
        @include('website.pages.shopGender.products')
