...
<body class="preload-wrapper">
    <div id="wrapper">
        ...
        @include('website.pages.singleBlog.header')
        <section class="flat-spacing">
            <div class="container">
                <div class="row">
                    @include('website.pages.singleBlog.content')
                    @include('website.pages.singleBlog.sidebar')
                </div>
            </div>
        </section>
        @include('website.pages.singleBlog.relatedBlogs')
